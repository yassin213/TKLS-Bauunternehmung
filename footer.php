        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-push-3 text-center">
                    <div class="footer-logo ">
                        <a href="./index.html"> <img alt="" src="images/logo-light.png" width="250"  height="80"></a>
                        <div class="clear"> </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-contact">
                            <li><i class="fa fa-map-marker"></i>Flughafen Str. 59 Stuttgart</li>
                            <li><i class="fa fa-envelope-o"></i>info@tkls-bau.de</li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-contact">
                            <li>Mon-Fr: 8-17 Uhr</li>
                            <li>Son-Fei: geschloßen</li>
                           <!--  <li>Friday: Closed</li>
            ...
            <div class="footer-copyright">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p class="pull-right text-uppercase">&copy; <?php echo date("Y"); ?> <a href="#">TKLS_BAU</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<!--     <link href="css/color.css" rel="stylesheet" id="theme-switch">

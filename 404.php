...
<body id="error-wrap">
    <div class="error-content">
        <div class="container text-center text-uppercase"> <img src="images/logo.png" class="img-responsive center-block" alt="" />
            <h2><span>Error</span>404<span>Page not found</span></h2>
...
<!--             <div class="error-social"> <a href=""><i class="fa fa-facebook"></i></a> <a href=""><i class="fa fa-twitter"></i></a> <a href=""><i class="fa fa-google-plus"></i></a> <a href=""><i class="fa fa-behance"></i></a> <a href="skype:?chat"><i class="fa fa-skype"></i></a> </div>
 -->            <div class="copyright">&copy; <?php echo date("Y"); ?><a href="#">TKLS_BAU</a></div>
        </div>
    </div>
    <!-- jquery -->
...
<script>jQuery(function(){jQuery('#colour-variations ul').styleSwitcher({defaultThemeId: 'theme-switch', hasPreview: false, cookie:{expires: 30, isManagingLoad: true}}); jQuery('.option-toggle').click(function(){jQuery('#colour-variations').toggleClass('sleep');}); if ( jQuery.cookie('layoutCookie') !='' ){jQuery('body').addClass(jQuery.cookie('layoutCookie'));}});</script>
    ...
    <script type="text/javascript">
        $("#ctimer").countdown("2017/01/01", function (event) {
            $(this).html(event.strftime('<div class="ct-block">%D<span>days</span></div><div class="ct-block">%H<span>Hours</span></div><div class="ct-block">%M<span>Minutes</span></div><div class="ct-block">%S<span>Seconds</span></div>'));
        });
    </script>
</body>
